                    ...
                    <div class="realfactory-navigation realfactory-item-pdlr clearfix ">
                        <div class="realfactory-main-menu" id="realfactory-main-menu">
                            <ul id="menu-main-navigation-1" class="sf-menu">
                                ...
                                <li class="menu-item menu-item-has-children realfactory-normal-menu"><a href="<?php echo site_url('/welcome/oxygen') ?>" class="sf-with-ul-pre">Our Products</a>
                                <ul class="sub-menu">
                                        ...
                                        <li class="menu-item"><a href="<?php echo site_url('/welcome/other') ?>">Other</a></li>
                                    </ul>
                                </li>
