            ...
            <div class="realfactory-page-title-wrap  realfactory-style-custom realfactory-left-align">
                ...
                <div class="realfactory-page-title-container realfactory-container">
                    <div class="realfactory-page-title-content realfactory-item-pdlr">
                        <h1 class="realfactory-page-title">Acetylene</h1>
                                                ...
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                                                        <div class="gdlr-core-title-item-title-wrap ">
                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 27px;font-weight: 700;letter-spacing: 0px;text-transform: none;color: #181818;">Acetylene<span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span></h3></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                        <div class="gdlr-core-text-box-item-content">
                                                            <p>Acetylene is an asphyxiant and may cause sedative impacts at high concentration. High concentrations may prohibit an adequate supply of oxygen to the lungs. Impacts of oxygen inadequacy resulting from straightforward asphyxiants may include fast breathing, reduced mental sharpness, impeded muscular coordination, faulty judgment, depression of all sensations, emotional instability, and fatigue.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align" style="padding-bottom: 20px;">
                                                        <div class="gdlr-core-text-box-item-content">
                                                            <p>Under typical working conditions, acetone isn't discharged from the chamber. Nonetheless, if the barrel is overcharged with acetone or acetylene, acetone may at times "spit" out. Acetone is primarily an aggravation and CNS depressant. High focuses may have central sensory system impacts causing a headache, nausea, dizziness, vomiting, and exhaustion.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr">
                                                        <div class="gdlr-core-title-item-title-wrap ">
                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 24px;font-weight: 700;letter-spacing: 0px;text-transform: none;">Application/Industries <span class="gdlr-core-title-item-title-divider gdlr-core-skin-divider"></span></h3></div>
                                                    </div>
                                                </div>
                                                <div class="gdlr-core-pbf-element">
                                                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align">
                                                        <div class="gdlr-core-text-box-item-content">
                                                            <p>Dissolved Acetylene is used in the following industries :<br>
                                                            	<ul>
                                                            		<li>Metal/Steel manufacturing</li>
                                                            		<li>Laboratories/Research institute</li>
